...
import Popover from "@/app/components/modal/popover";
      ...
      <Popover
        content={
          <div className="w-full rounded-md  p-2 sm:w-56">
            ...
            <button
              className="relative flex w-full items-center justify-start space-x-2 rounded-md p-2 text-left text-sm transition-all duration-75"
              onClick={() => signOut()}
            >

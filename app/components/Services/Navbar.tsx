    ...
    <div className='border-b flex flex-col sm:flex-row items-start sm:items-center sm:pr-10 bg-gray-100'>
      ...
      <div className='flex sm:items-center pl-8 pb-3 sm:pb-0'>
        ...
        <a
            ...
            className="rounded-lg flex ml-3 mb-3 space-x-3 inline-flex justify-center items-center justify-center px-6 mt-1 py-2 border hover:scale-105 transition-all duration-75 border-gray-200 bg-white max-w-fit mx-auto bg-slate-200 "
          >
